        ...
        return (
            <div className="">
                ...
                <div className="connect">
                    ...
                    <span><label>client:</label><Input style={{width: 120}}
                                                       onChange={this.handleInputChange.bind(this, "clientId")}
                                                       defaultValue={this.state.clientId}/></span>
                    <span>host:<Input style={{width: 160}} onChange={this.handleInputChange.bind(this, "host")}
                                      defaultValue={this.state.host}/></span>

                    <span>port:<InputNumber style={{width: 100}} onChange={this.handleInputChange.bind(this, "port")}
                                            defaultValue={this.state.port}/></span>
                ...
                <div className="publish">
                    <h3>publish</h3>
                    <span>topic:<Input style={{width: 120}} type="text" defaultValue={this.state.mqttTopic}
                                       onChange={this.handleInputChange.bind(this, "mqttTopic")}/></span>
                    <span>msg:<Input style={{width: 120}} type="text" defaultValue={this.state.mqttMessage}
                                     onChange={this.handleInputChange.bind(this, "mqttMessage")}/></span>
                    <span>
                    qos:
                    <Select defaultValue={this.state.mqttQos} style={{width: 60}}
                            onChange={this.handleInputChange.bind(this, "mqttQos")}>
                    ...
                    <span>
                    retain:
                    <Select defaultValue={this.state.mqttRetain}
                            onChange={this.handleInputChange.bind(this, "mqttRetain")}>
                        <Select.Option value="0">false</Select.Option>
                        <Select.Option value="1">true</Select.Option>
                    </Select></span>
                ...
                <div className="subscribe">
                    ...
                    <span>topic:<Input style={{width: 120}} type="text" defaultValue={this.state.subTopic}
                                       onChange={this.handleInputChange.bind(this, "subTopic")}/></span>
                    <span>
                    qos:
                    <Select style={{width: 60}} defaultValue={this.state.subQos}
                            onChange={this.handleInputChange.bind(this, "subQos")}>
                        <Select.Option value="0">0</Select.Option>
                        <Select.Option value="1">1</Select.Option>
                        <Select.Option value="2">2</Select.Option>
                    </Select></span>
